...
namespace Hypertable.Test
{
    ...
    public class TestContext
    {
        ...
        public void CreateContextConnectionString()
        {
            ...
            if (Context.HasContext(ContextKind.Hyper)) {
            ...
            if (Context.HasContext(ContextKind.Hamster)) {
            ...
            if (Context.HasContext(ContextKind.SQLite)) {
        ...
        public void CreateContextProperties() {
            ...
            if (Context.HasContext(ContextKind.Hyper)) {
                properties = new Dictionary<string, object> { { "Ht4n.Provider", "Hyper" }, { "Ht4n.Uri", "net.tcp://google.com:1000" } };
