...
namespace Hypertable {
	...
	/// </code>
	/// </example>
	public interface class INamespace : public IDisposable {
		...
		public:
			...
			ITable^ OpenTable( String^ name, OpenDispositions dispo );
			...
			/// <returns>Opened table.</returns>
			/// <seealso cref="OpenDispositions"/>
			ITable^ OpenTable( String^ name, String^ schema, OpenDispositions dispo );
